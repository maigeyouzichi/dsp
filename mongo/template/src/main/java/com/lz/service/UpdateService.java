...
public class UpdateService {
    ...
    public String update() {
        // 创建条件对象
        Criteria criteria = Criteria.where("age").is(996);
        // 创建查询对象，然后将条件对象添加到其中
        Query query = new Query(criteria);
        // 创建更新对象,并设置更新的内容
        Update update = new Update().set("age", 997).set("name", "zhangsansan997");
