...
//        String collectionName = "users1";
     ...
     * @return 创建集合的结果
     */
    public String createCollectionFixedSize(String collectionName, long size, long max) {
        // 设置集合名称
...
//        long max = 5L;
     ...
     * @return 创建集合结果
     */
    public String createCollectionValidation(String collectionName, Integer age) {
        // 设置集合名称
//        String collectionName = "users3";
        // 设置验证条件,只允许年龄大于20的用户信息插入
        CriteriaDefinition criteria = Criteria.where("age").gt(age);
        // 设置集合选项验证对象
        CollectionOptions collectionOptions = CollectionOptions.empty()
